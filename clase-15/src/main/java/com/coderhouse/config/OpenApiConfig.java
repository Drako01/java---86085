...
public class OpenApiConfig {
	...
	OpenAPI customOpenApi() {
		return new OpenAPI().info(new Info()
				.title("API REST Full | Java | CoderHouse | Comision 86085")
				.version("1.2.0")
				...
				.license(new License()
						.name("Licencia")
						.url("https://github.com/Drako01/java---86085?tab=MIT-1-ov-file"))
				)
				.servers(List.of(
						new Server()
				...
				.externalDocs(new ExternalDocumentation()
						...
						.url("https://github.com/Drako01/java---86085/wiki"));
	}
}
